...
const clearAll = () => {
  ...
  return (
    ...
    <Box style={{marginTop:"15px"}} className="breadcrumb" >
      <Breadcrumb  routeSegments={[{ name: 'Applicant', path: '/Applicant' }, { name: 'ListJobs' }]}  />
    </Box>
    ...
    <Button  onClick={handleClickOpen} style={{ backgroundColor: "#000033", color: "white",width:'250px',height:'250px',padding: "60px 30px", margin: "0px 2px", fontSize: '15px', borderRadius: '10px', fontFamily: 'Roboto","Helvetica","Arial",sans-serif' }} size="small">Apply</Button> 
