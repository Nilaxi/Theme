...
import { Card, Checkbox, Grid, IconButton, Input, TextField } from '@mui/material';
...
const  JwtRegistrationForApplicant =() => {
...
<br/>
                        ...
                        <Button
                             style={{height:"36px", width:"40%",backgroundColor:'#000033'}}
                              component="label"
                              role={undefined}
                              variant="contained"
                              tabIndex={-1}
                             ...
                             <Button
                             disabled
                             style={{height:"36px",borderColor:"none", width:"40%",backgroundColor: '#000033',color:'white'}}
                              component="label"
...
export default JwtRegistrationForApplicant